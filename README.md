...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/cloudflare-demo-app)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/cloudflare-demo-app
```

A live public deployment of this template is available at [https://cloudflare-demo-app.templates.workers.dev](https://cloudflare-demo-app.templates.workers.dev)
